...
class Load_Dependencies
{
  ...
  {
    $base_path = WOO_KASANI_ADMIN_DIR . 'js/';
  ...
  {
    $base_path = WOO_KASANI_ADMIN_DIR . 'css/';
  ...
  private function get_options_scripts()
  {
    return [
      'logic.js' => [
        ...
        //     'nonce' => wp_create_nonce('mi_metabox_productos_nonce'),
            // 'post_id' => $post ? $post->ID : 0
          // ]
        // ],
      ],
      'btn-toggle-cpt-promotions.js' => [
        'dependencies' => ['jquery'],
        'arguments' => [],
        'restricted_scripts' => [],
      ],
  ...
  {
    $base_uri = WOO_KASANI_ADMIN_URL . $directory . '/';
